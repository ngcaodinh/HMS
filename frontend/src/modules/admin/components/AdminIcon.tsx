...
/**
 * Render một icon SVG vẽ tay dùng chung cho module Admin.
 * @param name - Tên icon thuộc `AdminIconName` cần render.
 * @param className - Class Tailwind cho kích thước/màu, mặc định là `h-5 w-5` và dùng `currentColor`.
 * @remarks Icon chỉ mang tính trình bày và được đánh dấu `aria-hidden`; nhãn truy cập nằm ở control cha.
 */
