...
/**
 * Hiển thị chi tiết kết quả xét nghiệm, cờ bất thường, tệp đính kèm và bản in báo cáo.
 *
 * @param labTestId Mã phiếu được chọn; `null` hiển thị trạng thái yêu cầu chọn phiếu.
 * @returns UI empty, loading, bảng kết quả hoặc nội dung history thành công.
 * @remarks Chi tiết lấy từ GET `/lab-tests/:labTestId`, gồm structured result và reference range để
 * ánh xạ đơn vị/ngưỡng/cờ bình thường. Link attachment dùng proxy có xác thực; quyền đọc do backend
 * quyết định. Component không có error boundary riêng, còn thao tác in mở tài liệu từ snapshot hiện tại.
 */
  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.actionRow}>
        ...
        {/* Tạo bản in từ dữ liệu đã tải để không tạo request mới hoặc thay đổi trạng thái phiếu. */}
        <button
