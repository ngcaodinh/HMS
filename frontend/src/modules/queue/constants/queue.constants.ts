...
export const SOCKET_QUEUE_TICKET_CALLED = 'queue.ticket.called';
export const SOCKET_QUEUE_TICKET_UPDATED = 'queue.ticket.updated';
export const SOCKET_QUEUE_BOARD_UPDATED = 'queue:board-updated';
