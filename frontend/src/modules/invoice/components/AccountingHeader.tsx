...
/**
 * Hiển thị tiêu đề và ngữ cảnh của màn hình thu ngân/kế toán đang mở.
 *
 * @param props - Màn hình hiện tại và số hồ sơ được workspace quản lý.
 * @param props.activeScreen - Mã bước nghiệp vụ dùng để chọn tiêu đề tương ứng.
 * @param props.patientCount - Số hồ sơ trong snapshot do workspace tải từ backend.
 * @remarks Component chỉ trình bày trạng thái điều hướng; quyền truy cập và dữ liệu tài chính
 * vẫn do workspace, backend và phiên đăng nhập bảo đảm.
 */
