...
/**
 * Xác nhận kết thúc ca và đăng xuất khỏi workspace kế toán.
 *
 * @param props - Trạng thái mở và callback đóng/xác nhận từ parent.
 * @param props.isOpen - false thì không render modal.
 * @param props.onClose - Giữ phiên hiện tại và đóng hộp thoại.
 * @param props.onConfirmLogout - Parent thực hiện logout và điều phối redirect/session cleanup.
 * @remarks Modal không tự kiểm tra giao dịch hay quyền; nó chỉ cảnh báo và phát callback. Lỗi logout
 * hoặc trạng thái phiên do lớp auth bên ngoài xử lý.
 */
