...
// Các mục này chỉ điều hướng trong workspace; chúng không thay thế kiểm tra quyền ở backend.
...
/**
 * Hiển thị điều hướng các bước tra cứu, lập hóa đơn, thanh toán, tạm ứng và báo cáo.
 *
 * @param props - Màn hình đang chọn và các callback do workspace sở hữu.
 * @param props.activeScreen - Mã bước được đánh dấu đang hoạt động.
 * @param props.onSelectScreen - Callback yêu cầu parent chuyển bước, không tự tải dữ liệu.
 * @param props.onLogoutClick - Callback mở xác nhận đăng xuất ở parent.
 * @remarks Sidebar không tự quyết định authorization; backend vẫn là nơi kiểm tra quyền truy cập
 * vào các thao tác tài chính và phiên đăng nhập.
 */
