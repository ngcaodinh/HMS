...
/**
 * Nút đăng xuất dùng chung, mở modal xác nhận trước khi gọi action kết thúc phiên.
 * @param ariaLabel Nhãn accessible mặc định là `Đăng xuất` cho nút mở modal.
 * @param children Nội dung hiển thị bên trong nút trigger.
 * @param className Class tùy chọn của nút trigger; mặc định không thêm class.
 * @param title Tooltip tùy chọn của nút trigger.
 * @remarks Modal có trạng thái xác nhận và loading; trong lúc request đang chạy các nút bị khóa.
 * Thành công hoặc lỗi đều do `performLogout` điều hướng về `/login`; component không hiển thị
 * error riêng. Modal chỉ là UI affordance, không thay thế authorization của BFF/backend.
 */
export function LogoutButton({
  ...
  /**
   * Xử lý click xác nhận: chặn click lặp, gọi BFF kết thúc phiên và luôn trả trạng thái loading
   * về false sau khi action hoàn tất hoặc điều hướng do lỗi.
   */
