...
import { identityRepository } from '../modules/identity/identityComposition';
import { jwtPort } from '../modules/identity/jwtPort';
import type { StaffUserRecord } from '../modules/identity/identityTypes';
...
const isIdentityTokenPayload = (payload: unknown): payload is { authVersion: number; userId: string } =>
  isRecord(payload)
